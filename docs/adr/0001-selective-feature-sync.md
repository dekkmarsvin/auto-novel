...
- Each **Curated Upstream Sync Commit** should include or reference a **Sync Manifest** that records the upstream range, accepted groups, rejected removals, fork adaptations, and validation commands.
